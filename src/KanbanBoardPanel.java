...
import java.awt.*;
    ...
    public class KanbanBoardPanel extends JPanel {
        ...
        int panelWidth = 200; // Adjusted panel width to 200 pixels
        ...
        public KanbanBoardPanel() {
            ...
            // Adjusted the panelWidth * 5 to 1000 to fit within a frame with width 1000 pixels
        ...
        public static void main(String[] args) {
            SwingUtilities.invokeLater(() -> {
                ...
                frame.setSize(1000, 800); // Set frame width to 1000 pixels
